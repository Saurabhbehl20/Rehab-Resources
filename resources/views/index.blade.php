...
@section('content')
  @if(is_category())
    @php $hero_zone=$category_search_hero_zones; @endphp
  @endif
  ...
  @if (have_posts())
    <section class="blogs-section bg-white pt-20 lg:pt-28 bg-cover lg:px-5">
      <div class="container mx-auto">
          <div class="block lg:grid grid-cols-3 text-center lg:px-4">
            @while(have_posts()) @php the_post();
              ...
              <div class="blogs-inner-col bg-white border-orange text-center border-4 pb-20 lg:pb-7 mb-24 mt-24 lg:mx-4 px-9{{$col_class}}">
                ...
                <div class="blogs-content pb-4 pt-4 royal-blue-color block lg:flex justify-between flex-wrap">
          ...
          <div class="block lg:grid grid-cols-1 text-center lg:px-4 pb-20">
